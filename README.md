...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pylodstorage-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pylodstorage-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pylodstorage
# for installing globally
pixi global install pylodstorage
```
...
It is possible to list all of the versions of `pylodstorage` available on your platform:
...
```
pixi search pylodstorage --channel conda-forge
```
